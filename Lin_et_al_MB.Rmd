...
Lin YV, Chen YL, De Palmas S, Denis V (submitted) Rapid switch in coral assemblage caused by bleaching at upper mesophotic depth. doi:  []()
...
## **Figure 1c - depth profile of Vanice**
```{r eval = TRUE, echo=T, message=F, warning=F}
...
# **Thermal environment**
## **Extract thermal data at the sampling site**
```{r eval = TRUE, echo=T, message=F, warning=F}
...
## **Statistic of thermal data used in the manuscript**
...
## **Figure 2 - thermal data in 2022 & 2023**
```{r eval = TRUE, echo=T, message=F, warning=F}
ggplot(data = df)+
  xlab('Date')+
...
## **Figure 4a - Major benthic categories absolute covers**
```{r eval = TRUE, echo=T, message=F, warning=F}
...
# **Temporal changes in the coral assemblage**
```{r eval = TRUE, echo=T, message=F, warning=F}
...
## **Figure 4b - Changes in coral relative covers**
```{r eval = TRUE, echo=T, message=F, warning=F}
...
# **Temporal change in coral bleaching status (transect level)**
```{r eval = TRUE, echo=T, message=F, warning=F}
...
## **Figure 5a - Change in coral bleaching status**
```{r eval = TRUE, echo=T, message=F, warning=F}
...
# **Temporal change in bleaching status of _A. tenella_ (transect level)**
```{r eval = TRUE, echo=T, message=F, warning=F}
...
## **Figure 5b - Change in bleaching status of _A. tenella_ between 2022 & 2023**
```{r eval = TRUE, echo=T, message=F, warning=F}
